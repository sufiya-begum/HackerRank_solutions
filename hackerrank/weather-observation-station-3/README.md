<h2><a href="https://www.hackerrank.com/challenges/weather-observation-station-3/problem" target="_blank" rel="noopener noreferrer">Weather Observation Station 3</a></h2>
...
| **Language** | DB2 |
| **Verdict** | ✅ Accepted |
| **Problem Link** | [HackerRank Challenge](https://www.hackerrank.com/challenges/weather-observation-station-3/problem) |
...
<p>where <strong>LAT_N</strong> is the northern latitude and <strong>LONG_W</strong> is the western longitude.</p></div></div></div></div></div>