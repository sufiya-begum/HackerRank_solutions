<h2><a href="https://www.hackerrank.com/challenges/weather-observation-station-11/problem" target="_blank" rel="noopener noreferrer">Weather Observation Station 11</a></h2>
...
| **Language** | DB2 |
| **Verdict** | ✅ Accepted |
| **Problem Link** | [HackerRank Challenge](https://www.hackerrank.com/challenges/weather-observation-station-11/problem) |
...
<p>where <em>LAT_N</em> is the northern latitude and <em>LONG_W</em> is the western longitude. </p></div></div></div></div></div>